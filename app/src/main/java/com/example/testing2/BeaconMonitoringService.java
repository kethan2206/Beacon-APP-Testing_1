...
public class BeaconMonitoringService extends Service implements BeaconConsumer, MonitorNotifier, RangeNotifier {
    ...
    private SplashScreenLauncherActivity mSplashActivity;
    ...
    public void onCreate() {
        ...
        //Init Points Display
        mPointsDisplay = new PointsDisplay(this);
    ...
    public void didEnterRegion(Region region) {
        ...
        for (Config.Beacon configBeacon : App.mConfig.getBeacons()) {
            ...
            if (configBeacon.getBeaconMac().matches(region.getBluetoothAddress())) {
                ...
                addingPoints(configBeacon,region);
    ...
    // Adding points
    private void addingPoints(Config.Beacon configBeacon,Region region){
        if (!mBeaconManager.mBeaconRegions.get(region)) {
            Log.i(this.getClass().getName(), "Region was unique. Adding points.");

            //Adding points
            mPointsDisplay.entries();
        }
    }
